...
It is an uncomfortable truth for a scientist to accept, but it is a truth nonetheless: the actual reason we don't have reproducible code is that we don't want it enough to wait for it, and we never will. Life is short, and computational reproducibility is slow.
