...
description: "Fun and games with spatial noise patterns, courtesy of the ambient package"
date: "2024-12-19"
categories: ["R", "Art"]
image: "ridged.png"
image-alt: "Fractal noise pattern that looks like white clouds against a teal sky"
--- 
...
In this post I'll introduce the [ambient package](https://ambient.data-imaginist.com/), developed by [Thomas Lin Pedersen](https://www.data-imaginist.com/), which supplies R bindings to a C++ library called FastNoise.
