...
A small slice through a very large data set, but one that contains the four variables that I need in almost every NHANES-based analysis: age, sex, height, and weight. 
