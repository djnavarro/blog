...
theme_custom <- function() {
  tran_rect <- ggplot2::element_rect(fill = NA, color = NA)
  ...
  ggplot2::`%+replace%`(
    ...
    ggplot2::theme(
      ...
      plot.background   = tran_rect,
      legend.background = tran_rect,
      legend.key        = tran_rect,
      ...
      axis.title.y  = ggplot2::element_text(color = "#888", angle = 90), 
      ...
      panel.background = ggplot2::element_rect(fill = "#ddd", color = "#ddd"),
    ) 
  )
}
