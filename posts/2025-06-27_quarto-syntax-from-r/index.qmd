...
So lovely, so sexy, so.... look, I need a moment, okay?
...
#| results: asis
quarto_group(list(
  quarto_tabset(content = pic, names = bbs, title = "Plot", level = 3),
  quarto_tabset(content = dat, names = bbs, title = "Data", level = 3)
))
```
