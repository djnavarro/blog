...
The first project is a fun [Tidy Tuesday](https://github.com/rfordatascience/tidytuesday/tree/main/data/2024/2024-12-17) project that makes these two absurd images:
...
tar_destroy("all")
fs::dir_delete("spells/_targets")
fs::dir_delete("spells/output")
```
...
if(fs::dir_exists("_site")) fs::dir_delete("_site")
```
...
```{r}
#| label: hacky-file-copy
#| echo: false
# this shouldn't be needed but I've forgotten how to do it in quarto
fs::dir_copy(
  path = "_site",
  new_path = here::here("_site", "posts", "2024-12-28_using-targets"), 
  overwrite = TRUE
)
```

You can browse the built website [here](./_site/).
