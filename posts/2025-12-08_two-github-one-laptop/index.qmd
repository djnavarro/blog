...
- More generally, this [gist](https://gist.github.com/pksunkara/988716) and the associated comment thread has a really comprehensive overview of the settings that can be customised via `.gitconfig`
