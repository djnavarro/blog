...
![[Midnight pals](https://www.midnightpals.com/)](midnight1.png)
...
![When I use the dot in my regex](feather1.jpg)

![When I check what the dot matches](feather2.jpg)
...
This post is getting long. We need a little break. Well, I need a little break. Anyway, here's the regex to detect words all words in the "Midnight Pals" dialog hissed by the JK Rowling character:
...
For a variety of reasons this makes me smile. But let's move on, shall we?
